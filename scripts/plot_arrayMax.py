...
plt.axvline(1.1 * 1024 * 1024, color = 'y', linestyle='--', label='L1 cache')
plt.axvline(36 * 1024 * 1024, color = 'r', linestyle='--', label='L2 cache')
plt.axvline(49.5 * 1024 * 1024, linestyle='--', label='L3 cache')
plt.legend()
